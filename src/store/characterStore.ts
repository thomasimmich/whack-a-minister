...
interface CharacterState {
  ...
  setCharacterCombination: (
    enemy: CharacterConfig,
    friend: CharacterConfig,
    timeBonus: CharacterConfig
  ) => void;
...
export const useCharacterStore = create<CharacterState>((set) => ({
  ...
  setCharacterCombination: (enemy, friend, timeBonus) =>
    set({ enemy, friend, timeBonus }),
