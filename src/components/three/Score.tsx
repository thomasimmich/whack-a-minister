  ...
  return (
    <React.Suspense fallback={null}>
      <Text
        ...
        fontSize={0.05} // Font size (default is 1)
        maxWidth={300} // Max width for text wrapping (default is Infinity)
        ...
        font={BASE_ASSET_URL + '/fonts/Inter-VariableFont_slnt,wght.ttf'} // URL to the font file (required)
